...
export const EmergencyQuickBar: React.FC<EmergencyQuickBarProps> = ({ currentLang, onSelectAction, onOpenContacts }) => {
  ...
  const quickActions = [
    ...
    {
      id: 'river-status',
      title: t.riverDamLevels,
      subtitle: t.riverDamDesc,
      icon: Waves,
      badge: 'UPDATED',
    ...
    {
      id: 'bulletin',
      title: t.govtAdvisories,
      subtitle: t.govtAdvisoriesDesc,
      icon: FileText,
      badge: 'OFFICIAL',
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <div className="flex items-center gap-2 text-xs font-bold text-[#059669] uppercase tracking-wider">
              ...
              <span>{t.rapidResponse}</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight mt-1">
              {t.emergencyActionPortal}
            </h2>
          </div>
